...
if __name__ == '__main__':
    ...
    # JOBS_TO_RUN = [
    #     {'job_name': 'GARCH', 'asset': 'SP500'},
    #     {'job_name': 'GBM',  'asset': 'SP500'},
    #     {'job_name': 'DLPM', 'asset': 'SP500'},
    #     {'job_name': 'DDPM', 'asset': 'SP500'}
    # ]
    # -------------------------------

    # --- 2. 设置全局生成参数 ---
    # 所有作业将使用相同的路径数量
    NUM_PATHS_TO_GENERATE = 10# <-- 在这里修改为你想要的值 should be 100 
    # ------------------------------------
