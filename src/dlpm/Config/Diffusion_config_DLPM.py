...
main_config = {
    ...
    # DLPM parameters
    'use_dlpm': True,
    'dlpm_alpha': 1.9,            # stable index; alpha=2 recovers the Gaussian limit
    # Financial paths are represented as ordered return coordinates.  The v2
    # audit uses coordinate-wise stable scales; isotropic path-level scaling is
    # retained only as an explicit ablation.
    'dlpm_isotropic': False,
    'dlpm_scale': 'scale_preserving',

    # 论文标准损失 (Sec. 3, arXiv:2407.18609)
    'dlpm_lploss': 1.0,           # finite-moment objective used by the frozen run
